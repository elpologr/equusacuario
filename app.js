...
var _videosRedes = {
    ...
    facebook: [
        ...
        // Ejemplo: { tipo: 'facebook', url: 'https://www.facebook.com/acuarioequusmorelia/videos/123456789', titulo: 'Video FB 1' }
    ],
    instagram: [
    ...
    tiktok: [
        ...
        // Ejemplo: { tipo: 'tiktok', url: 'https://www.tiktok.com/@acuarioequusmorelia/video/123456', titulo: 'TikTok 1' }
    ]
};
...
(function() {
    ...
    function abrirModalProducto(card) {
        ...
        const eventoMap = {
            'agua-dulce': 'Agua Dulce', 'agua-salada': 'Agua Salada',
            'tropical': 'Peces Tropicales', 'goldfish': 'Goldfish',
            'tortuga': 'Tortugas', 'marino': 'Marino',
            'comida-viva': 'Comida Viva', 'congelado': 'Congelado',
            'liofilizado': 'Liofilizado', 'premium': 'Premium',
            'pecera-nueva': 'Pecera Nueva', 'mantenimiento': 'Mantenimiento',
            'acuario-pez': 'Para Peces', 'acuario-tortuga': 'Para Tortugas',
        ...
        document.getElementById('mpBtnWhatsapp').onclick = () => {
            ...
            window.open('https://wa.me/524432274721?text=' + texto, '_blank');
        };
...
function abrirModalCantidad(card) {
    ...
    _mcCantidadActual = 1;
    var nombre = card.getAttribute('data-nombre')
        || (card.querySelector('.nombre-producto, .card-nombre, h3, .producto-nombre') || {}).textContent
        || 'Producto';
    nombre = nombre.trim();
...
function pedirCotizacionWA() {
    ...
    // Construir mensaje
    var lineas = ['Hola, me gustaría pedir una cotización de los siguientes productos de Acuario Equus Morelia:\n'];
    ...
    setTimeout(function() {
        window.open('https://wa.me/524432274721?text=' + encodeURIComponent(mensaje), '_blank');
        btn.disabled = false;
...
document.addEventListener('click', function(e) {
    if (!e.target.closest('#imgPerfilBtn') &&
        ...
        !e.target.closest('#tituloVelasEquus') &&
...
function compartirEnWhatsApp() {
    var texto = encodeURIComponent('🕯️ Mira este producto de Acuario Equus Morelia: ' + _scNombreActual + '\n' + _scUrlActual);
